...
public class HTSeqUtilsTest {
  ...
  @Test
  public void testFeaturesOverlapped() throws KenetreException, IOException {
    ...
    results = HTSeqUtils.featuresOverlapped(ivSeq, annot, OverlapMode.UNION, StrandUsage.YES);
    assertTrue(results.contains("a"));
    assertFalse(results.contains("b"));

    results =
        HTSeqUtils.featuresOverlapped(
            ivSeq, annot, OverlapMode.INTERSECTION_NONEMPTY, StrandUsage.YES);
    assertTrue(results.contains("a"));
    assertFalse(results.contains("b"));

    results =
        HTSeqUtils.featuresOverlapped(
            ivSeq, annot, OverlapMode.INTERSECTION_STRICT, StrandUsage.YES);
    assertTrue(results.contains("a"));
    assertFalse(results.contains("b"));
