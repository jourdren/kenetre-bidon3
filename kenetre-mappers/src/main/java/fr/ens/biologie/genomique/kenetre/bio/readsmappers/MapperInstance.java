...
public class MapperInstance {
  ...
  public void makeArchiveIndex(final InputStream genomeIs,
    ...
    final File genomeTmpFile = File.createTempFile(
        this.applicationName + "-genome", ".fasta", getTemporaryDirectory());
  ...
  public void makeArchiveIndex(final File genomeFile,
    ...
    final String indexTmpDirPrefix = this.applicationName
  ...
  MapperInstance(Mapper mapper, MapperExecutor executor, final String version,
      ...
      final String applicationName, final GenericLogger logger)
      throws IOException {
