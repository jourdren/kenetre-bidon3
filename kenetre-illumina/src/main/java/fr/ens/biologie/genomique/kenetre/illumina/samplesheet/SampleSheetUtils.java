...
import static fr.ens.biologie.genomique.kenetre.illumina.samplesheet.Sample.DESCRIPTION_FIELD_NAME;
    ...
    for (String fieldName : Arrays.asList("sampleref", INDEX1_FIELD_NAME,
      ...
      if (table.isSampleFieldName(fieldName)) {
        throw new KenetreRuntimeException(
            "A required field is Missing in the samplesheet to create the quality control report: "
