 ...
 */
public interface ReadAlignmentFilter {

  /**
   * Filter a list of alignments from a list of alignment of one unique read. All the read id in the
   * records are the same. The input list is modified after the call of the method.
   *
