...
public final class Alphabets {
  ...
  private static final Set<Character> AMBIGUOUS_DNA_ALPHABET_LETTERS =
      toUnmodifiableSet(
          new char[] {'G', 'A', 'T', 'C', 'R', 'Y', 'W', 'S', 'M', 'K', 'H', 'B', 'V', 'D', 'N'});
  ...
  private static final Set<Character> AMBIGUOUS_RNA_ALPHABET_LETTERS =
      toUnmodifiableSet(
          new char[] {'G', 'A', 'U', 'C', 'R', 'Y', 'W', 'S', 'M', 'K', 'H', 'B', 'V', 'D', 'N'});
  ...
  public static final Alphabet AMBIGUOUS_DNA_ALPHABET =
      new Alphabet() {
  ...
  public static final Alphabet UNAMBIGUOUS_DNA_ALPHABET =
      new Alphabet() {
  ...
  public static final Alphabet AMBIGUOUS_RNA_ALPHABET =
      new Alphabet() {
  ...
  public static final Alphabet UNAMBIGUOUS_RNA_ALPHABET =
      new Alphabet() {
  ...
  public static final Alphabet READ_DNA_ALPHABET =
      new Alphabet() {
