...
public final class IlluminaReadId {
   ...
   */
  public final void parse(final Sequence sequence) throws KenetreException {
   ...
   * @throws KenetreException if the id is not an Illumina id
   */
  public final void parse(final String readId) throws KenetreException {
   ...
   * @throws KenetreException if the id is not an Illumina id
   */
  public IlluminaReadId(final String readId) throws KenetreException {
   ...
   * @throws KenetreException if the id is not an Illumina id
   */
  public IlluminaReadId(final Sequence sequence) throws KenetreException {
