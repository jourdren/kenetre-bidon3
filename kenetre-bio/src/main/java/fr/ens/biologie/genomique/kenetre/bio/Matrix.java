...
/**
 * This interface define a matrix. This a generalization of the ExpressionMatrix.
 *
...
public interface Matrix<E> {
  ...
  /**
   * Test if the matrix is empty. A matrix is empty when the size of the matrix is 0, and no row or
