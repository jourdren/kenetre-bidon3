...
/**
 * This class define an abstract AlignmentsFilter that contains default code for some methods of
 * AlignmentFilter.
 *
 * @since 1.1
 * @author Laurent Jourdren
 */
public abstract class AbstractReadAlignmentFilter implements ReadAlignmentFilter {
  ...
  public void setParameter(final String key, final String value) throws KenetreException {
    ...
    throw new KenetreException("Unknown parameter for " + getName() + " alignments filter: " + key);
  }
